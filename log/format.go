...
func TerminalFormat(r slog.Record, fieldPadding map[string]int, commonAttrs []slog.Attr, usecolor bool) []byte {
	...
	logfmt(b, fieldPadding, commonAttrs, r, color)

	return b.Bytes()
}

func logfmt(buf *bytes.Buffer, fieldPadding map[string]int, commonAttrs []slog.Attr, r slog.Record, color int) {
	attrs := []slog.Attr{}
