...
func (q *queue) Results(block bool) []*fetchResult {
	...
	for _, result := range results {
		...
		// TODO: what if gasUsed is 0?
		// TODO: do we need to keep the resultSize EWMA above?
		q.resultGasSizeRatio = common.StorageSize(blockCacheSizeWeight)*(size/common.StorageSize(result.Header.GasUsed)) +
	...
	// TODO: calculate throttle target (gasUsed/blockSize)
	throttleThreshold = q.resultCache.SetThrottleTarget(uint64(q.resultGasSizeRatio))
