...
var EVMMAXAddmodxCost [16]uint64 = [16]uint64{1,1,1,1,2,1,2,2,2,3,3,3,3,3,4,4}
var EVMMAXMulmontxCost [16]uint64 = [16]uint64{1,1,2,2,3,2,6,7,9,11,13,15,18,20,23,26}
