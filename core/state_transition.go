...
func (st *StateTransition) TransitionDb() (*ExecutionResult, error) {
	...
	if st.evm.TxContext.Accesses != nil {
		if msg.To() != nil {
			...
			gas += st.evm.TxContext.Accesses.TouchAddressOnWriteAndChargeGas(toBalance, pre.Bytes())
			...
			gas += st.evm.TxContext.Accesses.TouchAddressOnWriteAndChargeGas(fromNonce, preTN[:])
		}
		...
		gas += st.evm.TxContext.Accesses.TouchAddressOnWriteAndChargeGas(fromNonce, preFN[:])
		gas += st.evm.TxContext.Accesses.TouchAddressOnWriteAndChargeGas(fromBalance, preFB[:])
	}
	st.gas -= gas
