...
func GenerateChain(config *params.ChainConfig, parent *types.Block, engine consensus.Engine, db ethdb.Database, n int, gen func(int, *BlockGen)) ([]*types.Block, []types.Receipts) {
	...
	genblock := func(i int, parent *types.Block, triedb *triedb.Database, statedb *state.StateDB) (*types.Block, types.Receipts) {
		...
		if isAmsterdam {
			b.accessList = make(bal.ConstructionBlockAccessList)
		}
		...
		var createBAL func(finalIdxReads *bal.StateAccessList, finalIdxMut *bal.StateMutations) *bal.BlockAccessList
		...
		block, err := b.engine.FinalizeAndAssemble(context.Background(), cm, b.header, statedb, &body, b.receipts, createBAL)
		if err != nil {
			panic(err)
		}
