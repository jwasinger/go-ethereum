...
/*
Element type signature shares uint256.Int type on 4 limbs only.
When EVMx256 is expanded to support a wide variety of limb sizes, there will be a number of 
arithmetic implementations and Element* types generated by a template
*/
type Element [4]uint64

// convert little-endian ordered, little-endian limbs to a base-10 number
...
/*
EVMx256 arithmetic implementations.  Note that the assumptions of modulus occupying all limbs and modinv = pow(-modulus, -1, 1<<64) are not checked.
*/
var ZeroElement = Element{0,0,0,0}

func (z *Element) MulModMont(x, y, mod *Element, modinv uint64) (error) {
