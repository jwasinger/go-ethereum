...
func gasCallStateful(evm *EVM, contract *Contract, stack *Stack, mem *Memory, memorySize uint64) (uint64, error) {
	...
	// TODO: probably need to safe add both of these costs below just to be sure?
	// the gas check above should prevent overflow here as the call won't reasonably
	// have enough gas to pass the above check and then overflow here.
